# Archived DigitalOcean integration prompt

This file previously held the one-off implementation prompt used to create the
container and DigitalOcean App Platform support. Its assumptions described the
