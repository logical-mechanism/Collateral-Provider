...
def collat_witness(tx_cbor: str, network: str, token: str) -> str:
    """
    Inputs:
    ...
    url = f"http://fjy3v62j7vqytvtviixsbixcmgyxgfolb7pg5bb3vcozxn4rrlu7z6ad.onion/{network}/collateral/"

    # Set up the SOCKS5 proxy to route through Tor
    proxies = {"http": "socks5h://127.0.0.1:9050", "https": "socks5h://127.0.0.1:9050"}

    headers = {"Authorization": f"Token {token}", "Content-Type": "application/json"}

    data = {"tx_body": tx_cbor}
